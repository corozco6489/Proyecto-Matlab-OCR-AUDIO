function varargout = VOZ_TXT(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @VOZ_TXT_OpeningFcn, ...
                   'gui_OutputFcn',  @VOZ_TXT_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function VOZ_TXT_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = VOZ_TXT_OutputFcn(hObject, eventdata, handles) 
...
wavwrite(yf,fs,strcat('D:\MATLAB\reconocimiento-de-voz-master\reconocimiento-de-voz-master\BD\',leer));
